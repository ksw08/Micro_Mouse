...
;* Date/Time created: Tue Aug 19 17:11:16 2025                 *
;***************************************************************
...
;	C:\algo\Compiler\bin\opt2000.exe C:\Users\kimsy\AppData\Local\Temp\TI16410 C:\Users\kimsy\AppData\Local\Temp\TI1644 
;	C:\algo\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -IC:\algo\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\kimsy\AppData\Local\Temp\TI1642 --template_info_file C:\Users\kimsy\AppData\Local\Temp\TI1646 --object_file DSP280x_Gpio.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
	.global	_InitGpio
...
_InitGpio:
;*** 27	-----------------------    asm(" EALLOW");
;*** 66	-----------------------    GpioCtrlRegs.GPAMUX1.all = 69632uL;
;*** 107	-----------------------    GpioCtrlRegs.GPAMUX2.all = 0x50a0515uL;
;*** 118	-----------------------    GpioCtrlRegs.GPBMUX1.all = 0uL;
;*** 204	-----------------------    GpioCtrlRegs.GPADIR.all = 0x2ccd3fffuL;
;*** 213	-----------------------    GpioCtrlRegs.GPBDIR.all = 7uL;
;*** 228	-----------------------    GpioCtrlRegs.GPAPUD.all = 0xcccfffffuL;
;*** 229	-----------------------    GpioCtrlRegs.GPBPUD.all = 0xffffffffuL;
;*** 231	-----------------------    GpioCtrlRegs.GPAQSEL1.all = 0uL;
;*** 232	-----------------------    GpioCtrlRegs.GPAQSEL2.all = 0uL;
;*** 233	-----------------------    GpioCtrlRegs.GPBQSEL1.all = 0uL;
;*** 235	-----------------------    asm(" EDIS");
;*** 235	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
 ...
 EALLOW
	...
	.dwpsn	"DSP280x_Gpio.c",204,2
        MOV       PH,#11469
        MOV       PL,#16383
        MOVL      @_GpioCtrlRegs+10,P   ; |204| 
	.dwpsn	"DSP280x_Gpio.c",213,2
        MOVB      ACC,#7
        MOVL      @_GpioCtrlRegs+26,ACC ; |213| 
	.dwpsn	"DSP280x_Gpio.c",228,2
        MOV       PH,#52431
        MOV       PL,#65535
        MOVL      @_GpioCtrlRegs+12,P   ; |228| 
	.dwpsn	"DSP280x_Gpio.c",229,2
        MOV       PH,#65535
        MOVL      @_GpioCtrlRegs+28,P   ; |229| 
	.dwpsn	"DSP280x_Gpio.c",231,2
        MOVB      ACC,#0
        MOVL      @_GpioCtrlRegs+2,ACC  ; |231| 
	.dwpsn	"DSP280x_Gpio.c",232,2
        MOVL      @_GpioCtrlRegs+4,ACC  ; |232| 
	.dwpsn	"DSP280x_Gpio.c",233,2
        MOVL      @_GpioCtrlRegs+18,ACC ; |233| 
	.dwpsn	"DSP280x_Gpio.c",235,2
 EDIS
	.dwpsn	"DSP280x_Gpio.c",236,1
        SPM       #0
        LRETR
        ; return occurs
	.dwattr DW$2, DW_AT_end_file("DSP280x_Gpio.c")
	.dwattr DW$2, DW_AT_end_line(0xec)
