...
DW$9	.dwtag  DW_TAG_loop
	.dwattr DW$9, DW_AT_name("C:\algo\main\DSP280x_SysCtrl.asm:L3:1:1755591076")
...
;*** 270	-----------------------    *(&SysCtrlRegs+13L) |= 0x8u;
;*** 271	-----------------------    *(&SysCtrlRegs+13L) |= 0x10u;
...
DW$12	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
 ...
 EALLOW
	...
	.dwpsn	"DSP280x_SysCtrl.c",270,2
        OR        @_SysCtrlRegs+13,#0x0008 ; |270| 
	.dwpsn	"DSP280x_SysCtrl.c",271,2
        OR        @_SysCtrlRegs+13,#0x0010 ; |271| 
