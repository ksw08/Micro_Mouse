...
;	C:\algo\Compiler\bin\opt2000.exe C:\Users\KSY\AppData\Local\Temp\TI02410 C:\Users\KSY\AppData\Local\Temp\TI0244 
;	C:\algo\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -IC:\algo\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\KSY\AppData\Local\Temp\TI0242 --template_info_file C:\Users\KSY\AppData\Local\Temp\TI0246 --object_file DSP280x_CpuTimers.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
...
;*** 129	-----------------------    asm(" EDIS");
;*** 132	-----------------------    ConfigCpuTimer(&CpuTimer0, 100.0F, 50.0F);
;*** 133	-----------------------    ConfigCpuTimer(&CpuTimer2, 100.0F, 500.0F);
;*** 134	-----------------------    *(&PieCtrlRegs+2L) |= 0x40u;
;*** 135	-----------------------    *(&PieCtrlRegs+2L) |= 1u;
;*** 136	-----------------------    IER |= 1u;
;*** 137	-----------------------    IER |= 0x2000u;
;*** 139	-----------------------    asm(" clrc INTM");
;*** 140	-----------------------    asm(" clrc DBGM");
;*** 140	-----------------------    return;
 ...
 clrc DBGM
	.dwpsn	"DSP280x_CpuTimers.c",142,1
        SUBB      SP,#2
	.dwcfa	0x1d, -2
        SPM       #0
        LRETR
	...
	.dwattr DW$19, DW_AT_end_line(0x8e)
